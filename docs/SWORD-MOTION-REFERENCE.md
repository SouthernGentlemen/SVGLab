...
Frames 14–21 are follow-through: blade rotation is already decelerating while pelvis/torso motion continues. Frames 24–42 are recovery. The cut ends forward; returning to guard is a new motion phase, not more slash.
